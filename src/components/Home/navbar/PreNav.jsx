...
export const PreNav = ({ showMenu, onClick }) => {
  return (
    <div className="bg-[#0b450c] h-full flex items-center px-4 sm:px-10 md:px-16 justify-between">
      <div className="w-24 bg-transparent">
        {/* <h1 className="text-2xl font-bold text-white">RUPI</h1> */}
        <img src={logo} alt="RUPI logo" />
      </div>
      <div className="hidden md:flex justify-end w-full items-center space-x-12">
        {/* <ul> */}
